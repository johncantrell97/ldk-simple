# ldk-simple
A node based on LDK with the goal of maximizing the readability of the code, especially for non-rustaceans.  This is not recommended to run on mainnet but is supposed to be a great reference for learning the components of LDK and how they fit together. 

## Installation
```
git clone https://github.com/johncantrell97/ldk-simple
```
